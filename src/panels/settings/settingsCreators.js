...
// Creator function for userColors container with search, trash button, and items wrapper
export function createUserColorsContainer(userData, itemCreator) {
  const container = document.createElement('div');
  container.className = 'settings-userColors-container';
  ...
  usernames.forEach(username => {
    const item = itemCreator(username, userData);
  ...
  // Trash button event listener (needs to be after itemsWrapper is created)
